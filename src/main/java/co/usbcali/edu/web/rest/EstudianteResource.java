...
import co.usbcali.edu.service.EstudianteService;
...
/**
 * REST controller for managing {@link co.usbcali.edu.domain.Estudiante}.
 */
@RestController
@RequestMapping("/api")
public class EstudianteResource {
    ...
    public Mono<ResponseEntity<Estudiante>> partialUpdateEstudiante(
        ...
        return estudianteRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Estudiante> result = estudianteService.partialUpdate(estudiante);
    ...
    public Mono<List<Estudiante>> getAllEstudiantes() {
        ...
        return estudianteService.findAll().collectList();
    }
    ...
    public Mono<ResponseEntity<Estudiante>> getEstudiante(@PathVariable Long id) {
        ...
        Mono<Estudiante> estudiante = estudianteService.findOne(id);
