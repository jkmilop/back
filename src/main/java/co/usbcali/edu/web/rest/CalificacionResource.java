...
import co.usbcali.edu.service.CalificacionService;
...
/**
 * REST controller for managing {@link co.usbcali.edu.domain.Calificacion}.
 */
@RestController
@RequestMapping("/api")
public class CalificacionResource {
    ...
    private static final String ENTITY_NAME = "backCalificacion";
    ...
    public Mono<ResponseEntity<Calificacion>> partialUpdateCalificacion(
        ...
        return calificacionRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Calificacion> result = calificacionService.partialUpdate(calificacion);
    ...
    public Mono<List<Calificacion>> getAllCalificacions() {
        ...
        return calificacionService.findAll().collectList();
    }
    ...
    public Mono<ResponseEntity<Calificacion>> getCalificacion(@PathVariable Long id) {
        ...
        Mono<Calificacion> calificacion = calificacionService.findOne(id);
