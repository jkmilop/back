...
import co.usbcali.edu.service.CursoService;
...
/**
 * REST controller for managing {@link co.usbcali.edu.domain.Curso}.
 */
@RestController
@RequestMapping("/api")
public class CursoResource {
    ...
    public Mono<ResponseEntity<Curso>> partialUpdateCurso(
        ...
        return cursoRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Curso> result = cursoService.partialUpdate(curso);
    ...
    public Mono<List<Curso>> getAllCursos() {
        ...
        return cursoService.findAll().collectList();
    }
    ...
    public Mono<ResponseEntity<Curso>> getCurso(@PathVariable Long id) {
        ...
        Mono<Curso> curso = cursoService.findOne(id);
