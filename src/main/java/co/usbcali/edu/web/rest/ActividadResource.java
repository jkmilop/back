...
import co.usbcali.edu.service.ActividadService;
...
/**
 * REST controller for managing {@link co.usbcali.edu.domain.Actividad}.
 */
@RestController
@RequestMapping("/api")
public class ActividadResource {
    ...
    public Mono<ResponseEntity<Actividad>> partialUpdateActividad(
        ...
        return actividadRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Actividad> result = actividadService.partialUpdate(actividad);
    ...
    public Mono<List<Actividad>> getAllActividads() {
        ...
        return actividadService.findAll().collectList();
    }
    ...
    public Mono<ResponseEntity<Actividad>> getActividad(@PathVariable Long id) {
        ...
        Mono<Actividad> actividad = actividadService.findOne(id);
