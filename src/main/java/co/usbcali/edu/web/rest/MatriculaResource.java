...
import co.usbcali.edu.service.MatriculaService;
...
/**
 * REST controller for managing {@link co.usbcali.edu.domain.Matricula}.
 */
@RestController
@RequestMapping("/api")
public class MatriculaResource {
    ...
    private static final String ENTITY_NAME = "backMatricula";
    ...
    public Mono<ResponseEntity<Matricula>> partialUpdateMatricula(
        ...
        return matriculaRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Matricula> result = matriculaService.partialUpdate(matricula);
    ...
    public Mono<List<Matricula>> getAllMatriculas() {
        ...
        return matriculaService.findAll().collectList();
    }
    ...
    public Mono<ResponseEntity<Matricula>> getMatricula(@PathVariable Long id) {
        ...
        Mono<Matricula> matricula = matriculaService.findOne(id);
