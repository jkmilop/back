...
class ActividadResourceIT {
    ...
    private static final Formato DEFAULT_FORMATO = Formato.QUIZ;
    private static final Formato UPDATED_FORMATO = Formato.ACTIVIDAD;
    ...
    void getAllActividads() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].formato")
            .value(hasItem(DEFAULT_FORMATO.toString()));
    }
    ...
    void getActividad() {
        ...
        webTestClient
            ...
            .jsonPath("$.formato")
            .value(is(DEFAULT_FORMATO.toString()));
    }
    ...
    void putExistingActividad() throws Exception {
        ...
        updatedActividad.nombre(UPDATED_NOMBRE).description(UPDATED_DESCRIPTION).estado(UPDATED_ESTADO).formato(UPDATED_FORMATO);
    ...
    void partialUpdateActividadWithPatch() throws Exception {
        ...
        partialUpdatedActividad.estado(UPDATED_ESTADO);
    ...
    void fullUpdateActividadWithPatch() throws Exception {
        ...
        partialUpdatedActividad.nombre(UPDATED_NOMBRE).description(UPDATED_DESCRIPTION).estado(UPDATED_ESTADO).formato(UPDATED_FORMATO);
