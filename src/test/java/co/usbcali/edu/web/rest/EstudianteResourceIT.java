...
class EstudianteResourceIT {
    ...
    void createEstudiante() throws Exception {
        ...
        assertThat(testEstudiante.getCodigo()).isEqualTo(DEFAULT_CODIGO);
    ...
    void putExistingEstudiante() throws Exception {
        ...
        updatedEstudiante.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).codigo(UPDATED_CODIGO).correo(UPDATED_CORREO);
        ...
        assertThat(testEstudiante.getCodigo()).isEqualTo(UPDATED_CODIGO);
    ...
    void partialUpdateEstudianteWithPatch() throws Exception {
        ...
        partialUpdatedEstudiante.nombre(UPDATED_NOMBRE).codigo(UPDATED_CODIGO);
    ...
    void fullUpdateEstudianteWithPatch() throws Exception {
        ...
        partialUpdatedEstudiante.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).codigo(UPDATED_CODIGO).correo(UPDATED_CORREO);
