...
class CursoResourceIT {
    ...
    @Test
    void checkTipoCursoIsRequired() throws Exception {
        int databaseSizeBeforeTest = cursoRepository.findAll().collectList().block().size();
        // set the field null
    ...
    void getAllCursos() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].tipoCurso")
            .value(hasItem(DEFAULT_TIPO_CURSO.toString()));
    }
    ...
    void getCurso() {
        ...
        webTestClient
            ...
            .jsonPath("$.tipoCurso")
            .value(is(DEFAULT_TIPO_CURSO.toString()));
    }
    ...
    void putExistingCurso() throws Exception {
        ...
        updatedCurso.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).estado(UPDATED_ESTADO).tipoCurso(UPDATED_TIPO_CURSO);
    ...
    void partialUpdateCursoWithPatch() throws Exception {
        ...
        partialUpdatedCurso.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).estado(UPDATED_ESTADO);
    ...
    void fullUpdateCursoWithPatch() throws Exception {
        ...
        partialUpdatedCurso.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).estado(UPDATED_ESTADO).tipoCurso(UPDATED_TIPO_CURSO);
