...
import co.usbcali.edu.IntegrationTest;
import co.usbcali.edu.domain.Profesor;
import co.usbcali.edu.repository.EntityManager;
...
class ProfesorResourceIT {
    ...
    public static Profesor createEntity(EntityManager em) {
        Profesor profesor = new Profesor().nombre(DEFAULT_NOMBRE).apellido(DEFAULT_APELLIDO).codigo(DEFAULT_CODIGO).correo(DEFAULT_CORREO);
        return profesor;
    }
    ...
    public static Profesor createUpdatedEntity(EntityManager em) {
        Profesor profesor = new Profesor().nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).codigo(UPDATED_CODIGO).correo(UPDATED_CORREO);
        return profesor;
    }
    ...
    void createProfesor() throws Exception {
        ...
        assertThat(testProfesor.getCodigo()).isEqualTo(DEFAULT_CODIGO);
    ...
    void putExistingProfesor() throws Exception {
        ...
        updatedProfesor.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).codigo(UPDATED_CODIGO).correo(UPDATED_CORREO);
        ...
        assertThat(testProfesor.getCodigo()).isEqualTo(UPDATED_CODIGO);
    ...
    void partialUpdateProfesorWithPatch() throws Exception {
        ...
        partialUpdatedProfesor.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).codigo(UPDATED_CODIGO).correo(UPDATED_CORREO);
