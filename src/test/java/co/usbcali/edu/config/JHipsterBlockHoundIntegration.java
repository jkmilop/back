...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("co.usbcali.edu.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("co.usbcali.edu.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
